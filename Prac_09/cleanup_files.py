...
def main():
    ...
    os.chdir("/volumes/LUKE'S USB 3/Semester 2 (2017)/CP1404 - Programming 1/Lyrics/Christmas")
    ...
    for filename in os.listdir('.'):
        ...
        if not os.path.isdir(filename):
            ...
            print(new_name)
            #shutil.move('AngelsWeHaveHeard.TXT', 'testing/' + 'new_christmas')
            ...
            #os.rename(._NewbornKing.txt, ._OldbornKing.txt)
